...
using Forecast.Filters;
using Forecast.Models;
using Forecast.Models.System;
...
namespace Forecast.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        [HttpPost]
        public JsonResult AddRoles(Forecast.Models.Roles role)
        {
            RoleView viewModel = new RoleView();
            int error = viewModel.AddRole(role);
            return Json(error);
        }
        ...
        {
            RoleView viewModel = new RoleView();
            int error = viewModel.DeleteRole(id);
            return Json(error);
        }
        #endregion
        ...
        #region Управление учетной записью
